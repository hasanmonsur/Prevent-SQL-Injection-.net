...
using WebSqlInjectionApi.Services;
...
builder.Services.AddSingleton<IUserSqlService, UserSqlService>();
builder.Services.AddSingleton<IUserDapperService, UserDapperService>();
// Configure Serilog
